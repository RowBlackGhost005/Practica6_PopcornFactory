...
private class PeliculaAdapter: BaseAdapter {
    ...
    constructor(peliculas: ArrayList<Pelicula> , contexto: Context){
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        var imagen = vista.findViewById(R.id.ivPelicula) as ImageView
        var titulo = vista.findViewById(R.id.tvTitulo) as TextView
    ...
    /*
        ...
        var vista = inflador.inflate(R.layout.activity_detalle_pelicula , null)

        var imagen = vista.findViewById(R.id.ivPeliculaImagen) as ImageView
        var descripcion = vista.findViewById(R.id.tvPeliculaDesc) as TextView
        var titulo = vista.findViewById(R.id.tvNombrePelicula) as TextView
